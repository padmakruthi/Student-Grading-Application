...
To automate the student grading process

To demonstrate integration of Machine Learning with a Web Application

To provide an easy-to-use interface for grade prediction

To learn Flask framework and ML deployment basics
